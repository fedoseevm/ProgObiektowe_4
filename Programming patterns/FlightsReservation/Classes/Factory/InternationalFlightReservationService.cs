...
{
    internal class InternationalFlightReservationService : IReservationService
    {
        private UserInput userInput;

        public FlightReservation MakeReservation()
        {
            InternationalFlightReservationBuilder builder = new InternationalFlightReservationBuilder();
        ...
        {
            Console.Clear();
            Console.WriteLine("=== Rezerwacja lotu międzynarodowego ===\n");
            ...
            while (true)
            {
                Console.Write("Numer paszportu: ");
                passportNumber = Console.ReadLine();
                if (!string.IsNullOrWhiteSpace(passportNumber))
                    break;

                Console.WriteLine("Numer paszportu nie może być pusty.");
            }
            ...
            while (true)
            {
                Console.Write("Czy wymagana jest wiza? (tak/nie): ");
                string visaInput = Console.ReadLine().ToLower();
                if (visaInput == "tak")
                {
                    isVisaRequired = true;
                    break;
                }
                else if (visaInput == "nie")
                {
            ...
            userInput = new UserInput(flightNumber, from, to, departureDate, arrivalDate, price, passportNumber, isVisaRequired);
